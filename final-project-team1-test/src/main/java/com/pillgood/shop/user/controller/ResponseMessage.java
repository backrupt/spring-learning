...
public class ResponseMessage {
    ...
    public static final String FIND_USERID = "회원 아이디 찾기 성공";
    public static final String FIND_USERPASSWORD = "회원 임시 비밀번호 발송 성공";
    ...
    public static final String CREATE_FAIL_EXISTED_USER = "회원아이디중복여부";
