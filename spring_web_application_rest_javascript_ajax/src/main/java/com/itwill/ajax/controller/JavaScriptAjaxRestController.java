...
public class JavaScriptAjaxRestController {
	...
	public String ajaxRequestGET(@PathVariable(name="id") String id) throws InterruptedException {
	...
	public String ajaxRequestPOST(@RequestParam(name="id") String id) throws InterruptedException {
		System.out.println(">>>"+id);
		String msg="";
		if(id.startsWith("guard")) {
			msg="사용가능";
	...
	*/
	...
	public Map<String,Object> ajaxRequestGET(@PathVariable(name="id") String id) throws InterruptedException {
		System.out.println(">>>"+id);
		int status = 0;
		String msg="";
	...
	@PostMapping(value = "/02.ajaxRequestPOST")
	public Map<String,Object> ajaxRequestPOST(@RequestParam(name="id") String id) throws InterruptedException {
		System.out.println(">>>"+id);
		int status = 0;
		String msg="";
		Object data = new ArrayList();
