...
const UserModifyFormComponent = async(userId)=>{
	const userModifyAction = async()=>{
		...
		const responseJsonObject = await FetchUser.userModifyAction(userJsonObject);
					...
					<td>
						...
						<table width="590" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									<td align="center">
										<input type="button" id="btn_user_modify_action" value="수정"> &nbsp;</td>
								</tr>	
							</tbody>
						</table>
...
export {UserModifyFormComponent}