...
public class GuestDaoImplJDBC implements GuestDao {
	...
	public int insert(Guest guest)throws Exception {
		...
		pstmt2.setString(1, guest.getGuest_name());
		pstmt2.setString(2, guest.getGuest_email());
		pstmt2.setString(3, guest.getGuest_homepage());
		pstmt2.setString(4, guest.getGuest_title());
		pstmt2.setString(5, guest.getGuest_content());
